...
class Pretrain_Model(torch.nn.Module):
    def __init__(self, emb_dim):
        ...
        self.pretrain_linear = torch.nn.Sequential(torch.nn.Linear(emb_dim, 2*emb_dim), torch.nn.ReLU(), torch.nn.Linear(2*emb_dim, 4*emb_dim), torch.nn.ReLU(), torch.nn.Linear(4*emb_dim, emb_dim), torch.nn.ReLU())
        ...
        self.pred_linear = torch.nn.Linear(self.emb_dim, 3)
